...
class TestFunction(TestCase):
    ...
    def test_get_dataset_metadata_1(self):
        ...
        df = _get_dataset_metadata(
            "CLIMAT-AFFAIRES", insee_date_test=future_date
        )
    ...
    def test_get_dataset_2(self):
        ...
        self.assertTrue(
            isinstance(data, pd.DataFrame) & isinstance(data1, pd.DataFrame)
        )
    ...
    def test_get_dimension_values(self):
        ...
        df = _get_dimension_values(
            "CL_PERIODICITE", insee_date_test=future_date
        )
